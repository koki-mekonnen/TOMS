...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary text-white bg-dark disabled elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        ...
        <span class="brand-text font-weight-light">OTOMS</span>
        </a>
        <!-- Sidebar -->
